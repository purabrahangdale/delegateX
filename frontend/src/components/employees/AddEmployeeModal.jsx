                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className={`w-full bg-slate-50 border ${errors.role ? "border-rose-300 focus:border-rose-500" : "border-slate-200 focus:border-indigo-500"} text-slate-800 text-xs p-3.5 rounded-xl outline-none transition font-sans cursor-pointer`}
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full bg-slate-50 border border-slate-200 focus:border-indigo-500 text-slate-800 text-xs p-3.5 rounded-xl outline-none transition font-sans"
                        />
                    </div>
